...
class BaseAgent(autonomous_agent.AutonomousAgent):
    def general_base_agent_setup(self, path_to_conf_file, parsed_sensors, data_to_record, record_frequency, display):
    ...
    def save(self, input_data):
        self.tick_data = self.tick_recorded_data(input_data)
    ...
    '''
    def _init(self):
        self._command_planner = RoutePlanner(4.0, 50.0, 257)
