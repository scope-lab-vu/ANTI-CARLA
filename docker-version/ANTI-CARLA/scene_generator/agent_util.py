...
def parameter_sampler(dynamic_parameters,static_parameters,folder,simulation_run,route_path,y,sampler,data_path,total_scenes,scene_num,initial_condition,constraints):
    """
    ...
    if sampler == "Grid":
        parameter_values, sampled_parameters = Grid_Search(dynamic_parameters,folder,simulation_run,route_path,y,initial_condition,constraints,weather_step,traffic_step,pedestrian_step)
...
def decode_scene_description(scene_config):
    ...
    for entry in scene_config['Constraints']:
        constraints.append((entry,scene_config['Constraints']))
...
def generate_scene_artifact_files(path,scene_config,sampler,folder,simulation_run,route_path,y,data_path,total_scenes,data_file,scene_num):
    """
    ...
    joined_parameter_list = parameter_sampler(dynamic_parameters,static_parameters,folder,simulation_run,route_path,y,sampler,data_path,total_scenes,scene_num,initial_condition,constraints)
