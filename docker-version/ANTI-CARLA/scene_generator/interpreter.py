...
def main(args,root,y,path,data_root):
    """
    ...
    generate_scene_artifact_files(path,scene_config,sampler,folder,simulation_run,route_path,y,data_path,total_scenes,data_file,scene_num)
...
if __name__ == '__main__':
        ...
        root,y,data_root = create_root_folder(args,path)
        #print(root,y,data_root)
        main(args,root,y,path,data_root)
