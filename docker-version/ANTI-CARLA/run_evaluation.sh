...
export CARLA_ROOT=/CARLA_0.9.10
export PROJECT_PATH=/ANTI-CARLA
export utils_route=/ANTI-CARLA/utils
...
for (( j=0; j<=$end-1; j++ ))
  do
    ...
    do
        ...
        python3.7 ${LEADERBOARD_ROOT}/leaderboard/leaderboard_evaluator.py \
        --scenarios=${SCENARIOS}  \
        --routes=${ROUTES} \
